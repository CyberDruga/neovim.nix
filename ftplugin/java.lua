...
local bundles = {
	vim.fn.glob(
		nixCats("java.java-debug-adapter")
...
vim.list_extend(
	bundles,
	vim.split(
		vim.fn.glob(nixCats("java.java-test") .. "/share/vscode/extensions/vscjava.vscode-java-test/server/*.jar", true),
		"\n"
	)
)
...
vim.list_extend(
	bundles,
	vim.split(
		vim.fn.glob(nixCats("java.eclipse-pde") .. "/share/vscode/extensions/yaozheng.vscode-pde/server/*.jar", true),
		"\n"
	)
)
